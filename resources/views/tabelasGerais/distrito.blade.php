            ...
            <div class="modal-dialog">
                <div class="modal-content">
                   <div class="modal-header" style="background-color:#0b301a; color: white">
                       <h4 class="modal-title col-sm-12" id="modelHeading"></h4>
                        ...
                        <form id="ItemForm" name="ItemForm" class="form-horizontal">
                           <input type="hidden" name="Item_id" id="Item_id">
                            ...
                            <div class="form-group">
                                <label for="nome" class=" control-label col-sm-12">Nome Do Distrito</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="nomeDistrito" name="nomeDistrito" placeholder="Nome Do Distrito" value="" maxlength="50" required="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="descricao" name="descricao" placeholder="Descricao dDo Distrito" value="" maxlength="50" required="">
                                </div>
                            </div>
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('distrito.index') }}",
        columns: [
            {data: 'DT_RowIndex', name: 'DT_RowIndex'},
            {data: 'id', name: 'id'},
            {data: 'nomeDistrito', name: 'nomeDistrito'},
            {data: 'provincia.nomeProvincia', name: 'provincia_id'},
    ...
    $('#createNewItem').click(function () {
        ...
        $('#modelHeading').html("Adicionar Distrito");
        $('#ajaxModel').modal('show');
    });
    
    $('body').on('click', '.editItem', function () {
      var Item_id = $(this).data('id');
      $.get("{{ route('distrito.index') }}" +'/' + Item_id +'/edit', function (data) {
          $('#modelHeading').html("Editar Distrito");
          $('#saveBtn').val("edit-user");
          $('#ajaxModel').modal('show');
          $('#Item_id').val(data.id);
          $('#nomeDistrito').val(data.nomeDistrito);
          $('#abreviacao').val(data.abriviacao);
    ...
    $('body').on('click', '.deleteItem', function () {
        ...
        $.ajax({
            type: "DELETE",
            url: "{{ route('distrito.store') }}"+'/'+Item_id,
            success: function (data) {
                table.draw();
            },
            error: function (data) {
