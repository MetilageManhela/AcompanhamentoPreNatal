                    ...
                    <div class="modal-body">
                        <form id="ItemForm" name="ItemForm" class="form-horizontal"  enctype="multipart/form-data" >
                           ...
                           <div class="row ">    
                               <div class="form-group col-md-6">
                                 <label for="name" class=" control-label ">Nome</label>
                                  <div class="">
                                    <input type="text" class="form-control" id="descricao" name="descricao" placeholder="Descricao Do Projecto" value="" maxlength="50" required="">
                                </div>
                               </div>
                                <div class="form-group col-md-4">
                                 <label for="fundo" class=" control-label ">Orçamento </label>
                                  <div class="">
                                      <input type="hidden" name="orcamento" id="orcamento" >
                                    <input  data-mask='#.##0,00'  class="form-control" id="orcamentoBruto" name="orcamentoBruto" placeholder="Orçamento Do Projecto" value="" maxlength="50" >
                                </div>
                               </div>
                             ...
                             <div class="row ">  
                                 ...
                                 <div class="form-group col-md-6">
                                  ...
                                  <input id="dataInicio" class="datepicker" readonly name="dataInicio">
                              </div>
                                 

                                 <div class="form-group col-md-6">
                                    <label> Data de Término</label>
                                    <input id="dataTermino" class="datepicker" readonly name="dataTermino">
                                 </div>
                                ...
                                <div class="form-group select2-blue">
                                    ...
                                    <select class="financiadores" id="financiadores" name="financiadores[]" multiple="multiple" data-placeholder="Selecione os Financiadores" style="width: 100%;" >
                           ...
                           <div class="form-group ">
                                 ...
                                 <div class="">
                                    <textarea id="objectivo" name="objectivo"  placeholder="Escreva aqui o bjectivo" class="form-control"></textarea>
                                </div>
                              </div>
...
<script type="text/javascript">
 $(function () {
    ...
    var table = $('.data-table').DataTable({
        ...
        columns: [
           ...
           // {data: 'DT_RowIndex', name: 'DT_RowIndex'},
            ...
            {data: 'dataTermino', name: 'dataTermino'},
            
          //  {data: 'observacao', name: 'observacao'},
            {data: 'financiador.descricao', name: 'financiador.descricao'},
    ...
    $('#createNewItem').click(function () {
        ...
        $('#modelHeading').html("Adicionar Projecto");
  ...
  // Utilizo o .slice(-2) para garantir o formato com 2 digitos.
    ...
    $('body').on('click', '.editItem', function () {
      ...
      $.get("{{ route('projecto.index') }}" +'/' + Item_id +'/edit', function (data) {
          $('#modelHeading').html("Editar Projecto");
 ...
 $('#saveBtn').click(function (e) {  
    ...
    $('body').on('click', '.deleteItem', function () {
        ...
        $.ajax({
            type: "DELETE",
            url: "{{ route('projecto.store') }}"+'/'+Item_id,
            success: function (data) {
                table.draw();
            },
            error: function (data) {
