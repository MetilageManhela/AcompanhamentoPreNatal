...
<head>
    ...
    <!-- themify-icons line icon -->
     <link rel="stylesheet" type="text/css" href="{{ asset('adminty\libraries\assets\icon\themify-icons\themify-icons.css') }}"
    <!-- ico font -->
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        <input type="text" name="email" class="form-control"  placeholder="Endereco de E-mail">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <img src="{{ asset('adminty\libraries\assets\images\auth\Logo-small-bottom.png') }}" alt="small-logo.png">
                                        </div>
                                    </div>
                                </div>
                            </div>
